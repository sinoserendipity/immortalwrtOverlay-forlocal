...
```
wget -c -O master.zip.tmp https://github.com/sinoserendipity/immortalwrtOverlay-forlocal/archive/refs/heads/master.zip && mv -f master.zip.tmp master.zip
